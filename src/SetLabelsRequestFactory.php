...
/**
 * Factory for creating requests to set (replace) all labels on an issue/PR
 *
 ...
 */
class SetLabelsRequestFactory
{
    /**
     * @param array<string> $labels Label names to set (replaces existing)
     */
    ...
    /**
     * Create HTTP request to set labels
     *
    ...
    public function create(): RequestInterface
    {
        ...
        $jsonBody = json_encode(['labels' => $this->labels], JSON_THROW_ON_ERROR);
