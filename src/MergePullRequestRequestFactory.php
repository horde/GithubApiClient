...
/**
 * Factory for creating requests to merge a pull request
 *
 ...
 */
class MergePullRequestRequestFactory
{
    public function __construct(
        ...
        private readonly MergePullRequestParams $params
    ) {}

    /**
     * Create HTTP request to merge a pull request
     *
