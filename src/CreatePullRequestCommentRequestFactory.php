...
/**
 * Factory for creating requests to create pull request comments
 *
 ...
 */
class CreatePullRequestCommentRequestFactory
{
    ...
    /**
     * Create HTTP request to create a pull request comment
     *
