...
/**
 * Factory for creating requests to update a Check Run
 *
 ...
 */
class UpdateCheckRunRequestFactory
{
    public function __construct(
        ...
        private readonly int $checkRunId,
        private readonly UpdateCheckRunParams $params
    ) {}

    /**
     * Create HTTP request to update a Check Run
     *
    ...
    {
        $url = sprintf(
            'https://api.github.com/repos/%s/%s/check-runs/%d',
            $this->repo->owner,
            $this->repo->name,
            $this->checkRunId
        );
