...
/**
 * Factory for creating requests to list repository activity events,
 * backed by `GET /repos/{owner}/{repo}/events`.
 *
 ...
 */
class ListRepositoryEventsRequestFactory
{
    ...
    {
        $base = sprintf('%s/repos/%s/events', $this->config->endpoint, $repo->getFullName());
