...
/**
 * Factory for creating requests to remove all labels from an issue or PR.
 *
 * Symmetric with RemoveLabelRequestFactory but addresses the collection
 * (no trailing label-name segment), so the API clears every label at once.
 *
 ...
 */
class RemoveAllLabelsRequestFactory
{
