...
/**
 * Factory for creating requests to create an installation access token
 *
 ...
 */
class CreateInstallationAccessTokenRequestFactory
{
    public function __construct(
        ...
        private readonly CreateInstallationAccessTokenParams $params
    ) {}

    /**
     * Create HTTP request to create an installation access token
     *
