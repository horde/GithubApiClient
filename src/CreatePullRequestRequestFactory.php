...
/**
 * Factory for creating requests to create a pull request
 *
 ...
 */
class CreatePullRequestRequestFactory
{
    public function __construct(
        ...
        private readonly CreatePullRequestParams $params
    ) {}

    /**
     * Create HTTP request to create a pull request
     *
