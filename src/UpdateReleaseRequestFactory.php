...
/**
 * Factory for creating requests to update a GitHub release
 *
 ...
 */
class UpdateReleaseRequestFactory
{
    public function __construct(
        ...
        private readonly UpdateReleaseParams $params,
    ) {}

    /**
     * Create HTTP request to update a release
     *
